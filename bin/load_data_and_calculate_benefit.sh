...
if [ "$1" == "-h" ]; then
  echo "Usage: `basename $0` [amount of lines to load]"
...
docker exec bf bash -c "python manage.py calculate_benefit 2022"
docker exec bf bash -c "python manage.py calculate_benefit 2023"