# Generated by Django 5.0.4 on 2024-07-29 06:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('preferred_estimation_engine', models.CharField(choices=[('InYearExtrapolationEngine', 'Ekstrapolation af beløb for måneder i indeværende år'), ('TwelveMonthsSummationEngine', 'Summation af beløb for de seneste 12 måneder')], max_length=100, null=True)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('offset_percent', models.DecimalField(decimal_places=2, max_digits=10, null=True)),
                ('person_year', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='bf.personyear')),
            ],
        ),
        migrations.CreateModel(
