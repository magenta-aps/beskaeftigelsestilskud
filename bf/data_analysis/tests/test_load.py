...
class LoadAnnualIncomeTest(BaseTestCase):
    ...
    def test_load(self):
        ...
        self.assertEqual(settlement.social_benefit_income, Decimal(0))
        ...
        self.assertIsNone(settlement.other_debt_interest_income)
        ...
        self.assertIsNone(settlement.account_extraord_entries_income)
        self.assertEqual(settlement.account_business_interest, Decimal(0))
        self.assertIsNone(settlement.account_business_interest_income)
        self.assertIsNone(settlement.account_business_interest_deduct)
        self.assertEqual(settlement.account_tax_result, Decimal(0))
        self.assertEqual(settlement.account_share_business_percentage, Decimal(0))
