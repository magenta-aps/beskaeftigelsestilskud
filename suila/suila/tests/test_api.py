...
class PersonMonthApiTest(ApiTestCase):
    ...
    def setUpClass(cls):
        ...
        cls.personmonth1b = PersonMonth.objects.create(
            ...
            benefit_calculated=Decimal(1100),
        ...
        cls.personmonth1c = PersonMonth.objects.create(
            ...
            benefit_calculated=Decimal(1200),
        ...
        cls.expected1a = {
            ...
            "benefit_calculated": "1000.00",
            "benefit_transferred": "0.00",
            "a_income": "10000.00",
            # "b_income": "0.00",
