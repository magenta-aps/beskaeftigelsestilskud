...
class TaxInformationPeriod(PermissionsMixin, models.Model):
    ...
    def get_person_month_filter_annotation_for_entire_year(
        ...
        Notes
        --------
        The "month" parameter is the month for which we are calculating benefit.
...
class JobLog(PermissionsMixin, models.Model):
    ...
    send_param = models.BooleanField(default=None, null=True)
    save_param = models.BooleanField(default=None, null=True)
