...
#   timestamp: 2026-09-01T10:02:06+00:00
...
class AnnualIncome:
    """
    Represents the annual income details of an individual.
    """
    ...
    pensionpayment: float | None = None
...
class MonthlyIncome:
    """
    Represents the monthly income details of an individual for an employer.
    """
...
class TaxInformation:
    """
    Tax related information presented as census.
    """
...
@dataclass
class MunicipalityInformation:
    """
    Tax related information about municipalities.
    """
...
@dataclass
class ServiceListResponseMunicipalityInformation:
    """
    Represents a generic class for a service list response containing items of type T.
    For a singular response data object use ServiceResponse.
    """

    data: list[MunicipalityInformation] | None = None
    message: str | None = None
    chunk: int | None = None
    chunk_size: int | None = None
    total_chunks: int | None = None
