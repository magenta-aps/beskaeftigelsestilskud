            ...
            context_data.update(
                {
                    ...
                    "quarantine_reason": person_year.quarantine_reason["label"],
                    "quarantine_value": person_year.quarantine_reason["value"],
...
class IncomeSignalType(IntegerChoices):
    ...
    UdenlandskPension = (5, _("Udenlandsk pension"))
...
class PersonDetailIncomeView(
    ...
    def get_monthly_income_signals(self) -> Iterable[IncomeSignal]:
        ...
        for item in qs:
            ...
            if item.foreign_pension_income > 0:
                yield IncomeSignal(
                    IncomeSignalType.UdenlandskPension,
                    format_employer(item.employer),
                    item.foreign_pension_income,
                    item.person_month.year_month,
                )
